...
pushd "$OPENJPEG_SOURCE_DIR"
    case "$AUTOBUILD_PLATFORM" in
        "windows")
            ...
            cmake . -G"Visual Studio 14" -DCMAKE_INSTALL_PREFIX=$stage -DCMAKE_SYSTEM_VERSION="10.0.14393.0"
        ...
        "windows64")
            ...
            cmake . -G"Visual Studio 14 Win64" -DCMAKE_INSTALL_PREFIX=$stage -DCMAKE_SYSTEM_VERSION="10.0.14393.0"
